...
export const SECTION_CARDS: {
  ...
  },
  {
    ...
    gradient: 'linear-gradient(150deg, #1E1245 0%, #33207A 100%)',
    shadow: '0 8px 28px rgba(51,32,122,0.32)',
    accentColor: '#7B5CF5',
  },
  {
    id: 'exercise',
    ...
    gradient: 'linear-gradient(150deg, #101B3F 0%, #1B2F72 100%)',
    shadow: '0 8px 28px rgba(20,40,120,0.32)',
    accentColor: '#2E6FEB',
  },
  {
    id: 'weaning',
  ...
  },
  {
    id: 'antiplato',
    title: 'Platô',
    subtitle: 'Análise automática da sua evolução de peso',
